...
- Treat `实现细节` as details required to deliver the MR core goal. Put incidental consistency cleanup such as test style, naming, assertion pattern, formatting, or local cleanup under `顺手完成` unless that cleanup is the MR core goal.
- Use `顺手完成：
